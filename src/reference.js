...
registerCustomPickerElement('stt-helper', async (el, { providerId, accessible }) => {
	const { default: Vue } = await import(/* webpackChunkName: "vue-lazy" */'vue')
	Vue.mixin({ methods: { t, n } })
	const { default: SttCustomPickerElement } = await import(/* webpackChunkName: "stt-helper-picker-lazy" */'./views/SttCustomPickerElement.vue')
	const Element = Vue.extend(SttCustomPickerElement)
