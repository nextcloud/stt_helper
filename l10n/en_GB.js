OC.L10N.register(
    ...
    "Some internal error occurred. Check logs to find out more." : "Some internal error occurred. Check logs to find out more.",
    "Audio file not found." : "Audio file not found.",
    "No permission to create recording file/directory, check log files and your installation." : "No permission to create recording file/directory, check log files and your installation.",
    ...
    "No audio file selected (Only MP3 format is supported)" : "No audio file selected (Only MP3 format is supported)",
