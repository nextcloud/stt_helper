OC.L10N.register(
    "stt_helper",
    {
    "Error in transcript access time update call" : "Produciuse un erro na actualización do tempo de acceso á transcrición da chamada.",
    "Multiple transcripts found" : "Atopáronse varias transcricións",
    ...
    "Speech To Text App" : "Aplicación de Conversión de voz a texto",
    "Transcription has finished!" : "Rematou a transcrición!",
    "Transcript: %1$s" : "Transcrición: %1$s",
    "View transcript" : "Ver a transcrición",
    "Transcription has failed!" : "Produciuse un fallo na transcrición!",
    "Error: %1$s" : "Erro: %1$s",
    "View error message" : "Ver a mensaxe de erro",
    ...
    "Error while loading results: {error}" : "Produciuse un erro mentres cargaba os resultados: {error}"
},
