OC.L10N.register(
    ...
    "No permission to create recording file/directory, contact your sysadmin to resolve this issue." : "Нет разрешения на создание файла/каталога записи, обратитесь к системному администратору для решения этой проблемы.",
