OC.L10N.register(
    ...
    "This app implements a smart picker provider that utilises the Speech to Text OCP API.\nIt enables the user to generate transcriptions of recorded audio or an audio file provided.\n\nNOTE: This integration requires a separate integration to be installed that exposes a SpeechToText processing provider, like the Whisper Speech-To-Text App, for example." : "Diese App implementiert einen Smart Picker-Anbieter, der die OCP-API von Sprache-zu-Text nutzt.\nDies ermöglicht dem Benutzer, Transkriptionen von aufgezeichnetem Audio oder einer bereitgestellten Audiodatei zu erstellen.\n\nHINWEIS: Für diese Integration muss eine separate Integration installiert werden, die einen Anbieter für die Verarbeitung von Sprache-zu-Text bereitstellt, wie z. B. die Whisper-App für Sprache-zu-Text.",
